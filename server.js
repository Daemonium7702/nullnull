  ...
  var searchString = args.slice(1).join(' ');
    ...
    var voiceChannel = message.member.voiceChannel;
		...
		if (!permissions.has('CONNECT')) {
			return message.channel.send('I got lost, make sure I have the proper permissions!');
		}
		if (!permissions.has('SPEAK')) {
			return message.channel.send('Mmnf KLmmnf SLkfmmmt, make sure I have the proper permissions!');
		}
