...
module.exports.run = async (client, message, args, tools )=> {
        ...
        if(timer[message.author.id] === 1) {
          ...
          message.channel.send('You have collected your daily allowance of $50')
           economy.updateBalance(defineduser + message.guild.id, parseInt(50)).then((i) => { // AND MAKE SURE YOU ALWAYS PARSE THE NUMBER YOU ARE ADDING AS AN INTEGER
            message.channel.send(`**<@${defineduser}> had $50 added/subtraction from their account.**`)
        });
